...
사용자가 충분한 정보를 제공하지 않더라도,
타겟
문제
강점
목적
을 gpt 가 스스로 추론하여 사용자에게 보여준뒤, 논리를 구성한다.

gpt 의 작성 순서는

3. **Main Content**  -> 4. **Brand Strength Highlight**  -> 5. **Emotional/Impactful Closing**  -> 2. **First Paragraph**  1. **5 Compelling Titles**

으로 강제한다. (must) 하지만 글을 모두 작성 후 실제 사용자에게는 번호 순서대로 글을 정리해 보여준다.
